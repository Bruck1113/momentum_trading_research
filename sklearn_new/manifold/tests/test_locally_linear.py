...
from sklearn_new import neighbors, manifold
from sklearn_new.manifold._locally_linear import barycenter_kneighbors_graph
...
def test_pipeline():
    ...
    from sklearn_new import pipeline, datasets
