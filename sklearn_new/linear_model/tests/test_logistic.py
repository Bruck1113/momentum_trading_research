...
from sklearn_new.datasets import load_iris, make_classification
...
from sklearn_new.preprocessing import LabelEncoder, StandardScaler
from sklearn_new.utils import compute_class_weight, _IS_32BIT
...
from sklearn_new.utils._testing import skip_if_no_parallel

from sklearn_new.exceptions import ConvergenceWarning
from sklearn_new.linear_model._logistic import (
    LogisticRegression,
