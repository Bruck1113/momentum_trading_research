...
from sklearn_new.utils.validation import check_array, check_consistent_length
...
from sklearn_new.metrics import auc
...
from sklearn_new.metrics._ranking import _ndcg_sample_scores, _dcg_sample_scores
from sklearn_new.metrics import ndcg_score, dcg_score
