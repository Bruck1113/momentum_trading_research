...
from sklearn_new.metrics import (f1_score, r2_score, roc_auc_score, fbeta_score,
                             log_loss, precision_score, recall_score,
                             jaccard_score)
from sklearn_new.metrics import cluster as cluster_module
from sklearn_new.metrics import check_scoring
from sklearn_new.metrics._scorer import (_PredictScorer, _passthrough_scorer,
                                     _MultimetricScorer,
                                     _check_multimetric_scoring)
from sklearn_new.metrics import accuracy_score
from sklearn_new.metrics import make_scorer, get_scorer, SCORERS
...
from sklearn_new.linear_model import Ridge, LogisticRegression, Perceptron
from sklearn_new.tree import DecisionTreeClassifier, DecisionTreeRegressor
...
from sklearn_new.model_selection import train_test_split, cross_val_score
