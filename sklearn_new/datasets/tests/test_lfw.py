...
from sklearn_new.externals._pilutil import pillow_installed, imsave
from sklearn_new.datasets import fetch_lfw_pairs
from sklearn_new.datasets import fetch_lfw_people
