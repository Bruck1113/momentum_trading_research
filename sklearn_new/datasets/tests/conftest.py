...
import pytest
from sklearn_new.datasets import fetch_20newsgroups
from sklearn_new.datasets import fetch_20newsgroups_vectorized
from sklearn_new.datasets import fetch_california_housing
from sklearn_new.datasets import fetch_covtype
from sklearn_new.datasets import fetch_kddcup99
from sklearn_new.datasets import fetch_olivetti_faces
from sklearn_new.datasets import fetch_rcv1
