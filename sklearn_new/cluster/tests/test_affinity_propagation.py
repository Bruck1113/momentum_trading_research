...
from sklearn_new.cluster import AffinityPropagation
from sklearn_new.cluster._affinity_propagation import (
    _equal_similarities_and_preferences
)
from sklearn_new.cluster import affinity_propagation
