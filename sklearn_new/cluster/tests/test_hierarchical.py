...
from sklearn_new.cluster import ward_tree
from sklearn_new.cluster import AgglomerativeClustering, FeatureAgglomeration
from sklearn_new.cluster._agglomerative import (_hc_cut, _TREE_BUILDERS,
                                            linkage_tree,
                                            _fix_connectivity)
from sklearn_new.feature_extraction.image import grid_to_graph
from sklearn_new.metrics.pairwise import PAIRED_DISTANCES, cosine_distances,\
    manhattan_distances, pairwise_distances
from sklearn_new.metrics.cluster import normalized_mutual_info_score
...
from sklearn_new.datasets import make_moons, make_circles
