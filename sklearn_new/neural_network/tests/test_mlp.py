...
from sklearn_new.datasets import load_digits, load_boston, load_iris
from sklearn_new.datasets import make_regression, make_multilabel_classification
...
from sklearn_new.neural_network import MLPRegressor
from sklearn_new.preprocessing import LabelBinarizer
from sklearn_new.preprocessing import StandardScaler, MinMaxScaler
