...
import sklearn_new
from sklearn_new.inspection import partial_dependence
from sklearn_new.inspection._partial_dependence import (
    _grid_from_X,
    _partial_dependence_brute,
    _partial_dependence_recursion
)
from sklearn_new.ensemble import GradientBoostingClassifier
from sklearn_new.ensemble import GradientBoostingRegressor
from sklearn_new.ensemble import RandomForestRegressor
...
from sklearn_new.preprocessing import PolynomialFeatures
from sklearn_new.preprocessing import StandardScaler
from sklearn_new.preprocessing import RobustScaler
from sklearn_new.pipeline import make_pipeline
from sklearn_new.dummy import DummyClassifier
from sklearn_new.base import BaseEstimator, ClassifierMixin, clone
...
from sklearn_new.utils import _IS_32BIT
from sklearn_new.utils.validation import check_random_state
from sklearn_new.tree.tests.test_tree import assert_is_subtree
...
@pytest.mark.parametrize('Estimator',
                         (sklearn_new.tree.DecisionTreeClassifier,
                          sklearn_new.tree.ExtraTreeClassifier,
                          sklearn_new.ensemble.ExtraTreesClassifier,
                          sklearn_new.neighbors.KNeighborsClassifier,
                          sklearn_new.neighbors.RadiusNeighborsClassifier,
                          sklearn_new.ensemble.RandomForestClassifier))
