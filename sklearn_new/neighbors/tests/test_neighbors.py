...
from sklearn_new import metrics
from sklearn_new import neighbors, datasets
...
from sklearn_new.neighbors import VALID_METRICS_SPARSE, VALID_METRICS
from sklearn_new.neighbors._base import _is_sorted_by_data, _check_precomputed
