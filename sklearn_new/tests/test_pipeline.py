...
from sklearn_new.utils.fixes import parse_version

from sklearn_new.base import clone, BaseEstimator, TransformerMixin
from sklearn_new.pipeline import Pipeline, FeatureUnion, make_pipeline, make_union
from sklearn_new.svm import SVC
from sklearn_new.neighbors import LocalOutlierFactor
from sklearn_new.linear_model import LogisticRegression, Lasso
from sklearn_new.linear_model import LinearRegression
from sklearn_new.cluster import KMeans
from sklearn_new.feature_selection import SelectKBest, f_classif
from sklearn_new.dummy import DummyRegressor
from sklearn_new.decomposition import PCA, TruncatedSVD
from sklearn_new.datasets import load_iris
from sklearn_new.preprocessing import StandardScaler
from sklearn_new.feature_extraction.text import CountVectorizer
