...
from sklearn_new.base import BaseEstimator, clone, is_classifier
...
from sklearn_new.base import TransformerMixin
...
def test_clone():
    ...
    from sklearn_new.feature_selection import SelectFpr, f_classif
...
def test_pickle_version_warning_is_issued_upon_different_version():
    ...
    message = pickle_error_message.format(estimator="TreeBadVersion",
                                          ...
                                          current_version=sklearn_new.__version__)
