...
from sklearn_new.utils._testing import check_docstring_parameters
from sklearn_new.utils._testing import _get_func_name
from sklearn_new.utils._testing import ignore_warnings
from sklearn_new.utils._testing import all_estimators
from sklearn_new.utils.estimator_checks import _enforce_estimator_tags_y
from sklearn_new.utils.estimator_checks import _enforce_estimator_tags_x
from sklearn_new.utils.deprecation import _is_deprecated
from sklearn_new.externals._pep562 import Pep562
...
with warnings.catch_warnings():
    ...
    PUBLIC_MODULES = set([
        pckg[1] for pckg in walk_packages(
            ...
            path=sklearn_new.__path__)  # type: ignore  # mypy issue #1422
...
def test_tabs():
    ...
    for importer, modname, ispkg in walk_packages(sklearn_new.__path__,
                                                  prefix='sklearn.'):
