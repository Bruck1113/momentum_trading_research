...
from sklearn_new.covariance import EmpiricalCovariance
from sklearn_new.datasets import make_spd_matrix
from io import StringIO
from sklearn_new.metrics.cluster import adjusted_rand_score
from sklearn_new.mixture import GaussianMixture
from sklearn_new.mixture._gaussian_mixture import (
...
from sklearn_new.exceptions import ConvergenceWarning, NotFittedError
from sklearn_new.utils.extmath import fast_logdet
...
def test_check_X():
    from sklearn_new.mixture._base import _check_X
    rng = np.random.RandomState(0)
...
def test_gaussian_mixture_log_probabilities():
    from sklearn_new.mixture._gaussian_mixture import _estimate_log_gaussian_prob
