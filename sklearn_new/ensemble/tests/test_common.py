...
from sklearn_new.base import is_classifier

from sklearn_new.datasets import make_classification
from sklearn_new.datasets import make_regression

from sklearn_new.linear_model import LogisticRegression, LinearRegression
from sklearn_new.svm import LinearSVC, LinearSVR, SVC, SVR
from sklearn_new.ensemble import RandomForestClassifier, RandomForestRegressor

from sklearn_new.ensemble import StackingClassifier, StackingRegressor
