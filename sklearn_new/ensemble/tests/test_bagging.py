...
from sklearn_new.dummy import DummyClassifier, DummyRegressor
from sklearn_new.model_selection import GridSearchCV, ParameterGrid
from sklearn_new.ensemble import BaggingClassifier, BaggingRegressor
from sklearn_new.linear_model import Perceptron, LogisticRegression
from sklearn_new.neighbors import KNeighborsClassifier, KNeighborsRegressor
from sklearn_new.tree import DecisionTreeClassifier, DecisionTreeRegressor
from sklearn_new.svm import SVC, SVR
from sklearn_new.random_projection import SparseRandomProjection
from sklearn_new.pipeline import make_pipeline
from sklearn_new.feature_selection import SelectKBest
from sklearn_new.model_selection import train_test_split
from sklearn_new.datasets import load_diabetes, load_iris, make_hastie_10_2
from sklearn_new.utils import check_random_state
from sklearn_new.preprocessing import FunctionTransformer
