...
from sklearn_new.ensemble import IsolationForest
from sklearn_new.ensemble._iforest import _average_path_length
from sklearn_new.model_selection import train_test_split
from sklearn_new.datasets import load_diabetes, load_iris
