...
from sklearn_new.decomposition import NMF, non_negative_factorization
from sklearn_new.decomposition import _nmf as nmf  # For testing internals
...
from sklearn_new.utils.extmath import squared_norm
