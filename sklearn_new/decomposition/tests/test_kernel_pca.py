...
from sklearn_new.decomposition import PCA, KernelPCA
from sklearn_new.datasets import make_circles
from sklearn_new.datasets import make_blobs
from sklearn_new.linear_model import Perceptron
...
from sklearn_new.utils.validation import _check_psd_eigenvalues
