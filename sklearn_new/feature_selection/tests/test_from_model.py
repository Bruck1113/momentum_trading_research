...
from sklearn_new.linear_model import LogisticRegression, SGDClassifier, Lasso
from sklearn_new.svm import LinearSVC
from sklearn_new.feature_selection import SelectFromModel
...
from sklearn_new.linear_model import PassiveAggressiveClassifier
