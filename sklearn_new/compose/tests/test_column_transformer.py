...
from sklearn_new.compose import (
...
from sklearn_new.preprocessing import StandardScaler, Normalizer, OneHotEncoder
from sklearn_new.feature_extraction import DictVectorizer
