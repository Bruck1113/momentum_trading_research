...
from sklearn_new.utils import deprecated
from sklearn_new.utils._testing import (assert_raises_regex,
                                    ignore_warnings,
                                    assert_warns, assert_raises,
                                    SkipTest)
from sklearn_new.utils.estimator_checks import check_estimator, _NotAnArray
from sklearn_new.utils.estimator_checks \
    import check_class_weight_balanced_linear_classifier
from sklearn_new.utils.estimator_checks import set_random_state
from sklearn_new.utils.estimator_checks import _set_checking_parameters
from sklearn_new.utils.estimator_checks import check_estimators_unfitted
from sklearn_new.utils.estimator_checks import check_fit_score_takes_y
from sklearn_new.utils.estimator_checks import check_no_attributes_set_in_init
from sklearn_new.utils.estimator_checks import check_classifier_data_not_an_array
from sklearn_new.utils.estimator_checks import check_regressor_data_not_an_array
from sklearn_new.utils.validation import check_is_fitted
from sklearn_new.utils.estimator_checks import check_outlier_corruption
from sklearn_new.utils.fixes import np_version, parse_version
from sklearn_new.ensemble import RandomForestClassifier
from sklearn_new.linear_model import LinearRegression, SGDClassifier
from sklearn_new.mixture import GaussianMixture
from sklearn_new.cluster import MiniBatchKMeans
from sklearn_new.decomposition import NMF
from sklearn_new.linear_model import MultiTaskElasticNet, LogisticRegression
from sklearn_new.svm import SVC
from sklearn_new.neighbors import KNeighborsRegressor
from sklearn_new.utils.validation import check_array
from sklearn_new.utils import all_estimators
...
class BadBalancedWeightsClassifier(BaseBadClassifier):
    ...
    def fit(self, X, y):
        ...
        from sklearn_new.utils import compute_class_weight
