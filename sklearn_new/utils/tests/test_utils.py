...
from sklearn_new.utils import _determine_key_type
from sklearn_new.utils import deprecated
from sklearn_new.utils import gen_batches
from sklearn_new.utils import _get_column_indices
from sklearn_new.utils import resample
from sklearn_new.utils import safe_mask
from sklearn_new.utils import column_or_1d
from sklearn_new.utils import _safe_indexing
from sklearn_new.utils import shuffle
from sklearn_new.utils import gen_even_slices
from sklearn_new.utils import _message_with_time, _print_elapsed_time
from sklearn_new.utils import get_chunk_n_rows
from sklearn_new.utils import is_scalar_nan
from sklearn_new.utils import _to_object_array
...
def test_deprecation_joblib_api(tmpdir):
    ...
    # sklearn.utils
    from sklearn_new.utils import parallel_backend, register_parallel_backend
    assert_no_warnings(parallel_backend, 'loky', None)
    assert_no_warnings(register_parallel_backend, 'failing', None)

    from sklearn_new.utils._joblib import joblib
